...
function M.get_highlights(colors, config)
    ...
    add_hl("Cursor", { fg = colors.bg, bg = colors.cursor })
    ...
    add_hl("IncSearch", { fg = colors.bg, bg = colors.red, bold = true })
    add_hl("Visual", { bg = colors.selection })
    add_hl("Directory", { fg = colors.blue, bold = true })
    
    -- Enhanced Diff highlights
    add_hl("DiffAdd", { fg = colors.git_add, bg = colors.bg_highlight, bold = true })
    add_hl("DiffChange", { fg = colors.git_change, bg = colors.bg_highlight })
    add_hl("DiffDelete", { fg = colors.git_delete, bg = colors.bg_highlight, bold = true })
    ...
    add_hl("SpellBad", { undercurl = true, sp = colors.error })
    add_hl("SpellCap", { undercurl = true, sp = colors.warning })
    add_hl("SpellRare", { undercurl = true, sp = colors.purple })
    add_hl("SpellLocal", { undercurl = true, sp = colors.info })
    add_hl("NonText", { fg = colors.fg_gutter })
    add_hl("SpecialKey", { fg = colors.purple })
    
    -- Enhanced Syntax highlights
    ...
    add_hl("Todo", { fg = colors.warning, bold = true })
